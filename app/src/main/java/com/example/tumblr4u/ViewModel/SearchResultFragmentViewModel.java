...
public class SearchResultFragmentViewModel extends AndroidViewModel {
    ...
    public void getResultPosts(String searchWord) {
...
//        postsList.setValue(tempList);
        ...
        repository.dataBaseGetResultPosts(Prefs.getToken(getApplication()), searchWord).enqueue(
                new Callback<ResultDataResponse>() {
                    @Override
                    public void onResponse(Call<ResultDataResponse> call,
                                           Response<ResultDataResponse> response) {
